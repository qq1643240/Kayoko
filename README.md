...
1. Download the latest `deb` from the [releases](https://github.com/owngoal-dev/Kayoko/releases).
...
The maintained source code is available at <https://github.com/owngoal-dev/Kayoko>.
